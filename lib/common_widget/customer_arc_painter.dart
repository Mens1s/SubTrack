...
class CustomerArcPainter extends CustomPainter {
  final double start;
  final double end;
  final double width;
  final double blurWidth;

  CustomerArcPainter({this.start = 0, this.end = 270, this.width = 15, this.blurWidth = 6});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var gradientColor = LinearGradient(colors: [
      TColor.secondary,
      TColor.secondary,
  ...
  @override
  bool shouldRepaint(CustomerArcPainter oldDelegate) => false;

  @override
  bool shouldRebuildSemantics(CustomerArcPainter oldDelegate) => false;
}
